...
co2_X, co2_y = (np.array(pan_co2["year"].loc[years_after_1989]).reshape(-1, 1), 
                pan_co2["co2"].loc[years_after_1989])

co2_X_train, co2_X_test, co2_y_train, co2_y_test = train_test_split(co2_X, co2_y, test_size=0.2, random_state=42)
